...
public class FourColorAboutBox extends javax.swing.JDialog {

    public FourColorAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(fourcolor.FourColorApp.class).getContext().getResourceMap(FourColorAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(fourcolor.FourColorApp.class).getContext().getActionMap(FourColorAboutBox.class, this);
